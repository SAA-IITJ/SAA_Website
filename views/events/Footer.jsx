        ...
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
            <a href="https://flowbite.com/" className="flex items-center">
              <img className="h-12 me-3" src="./assets/saa_logo_jpeg.jpeg" alt="..." />
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-4">
            <div>
              <h2 className="mb-6 text-sm font-extrabold text-gray-900 uppercase dark:text-black">Resources</h2>
              <ul className="text-gray-500 dark:text-black font-medium">
                ...
                <li className="mb-4">
                  <a href="/team" className="hover:underline">Events</a>
                </li>
                <li className="mb-4">
                  <a href="/team" className="hover:underline">Flagship Events</a>
                </li>
              </ul>
            </div>
            <div style={{ paddingTop: "40px" }}>
              <ul className="text-gray-500 dark:text-black font-medium">
                <li className="mb-4">
                  <a href="/team" className="hover:underline">Dashak</a>
                </li>
                <li className="mb-4">
                  <a href="/team" className="hover:underline">Visit IITJ</a>
                </li>
                <li className="mb-4">
                  <a href="/team" className="hover:underline">Giving Back</a>
                </li>
                <li className="mb-4">
                  <a href="/team" className="hover:underline">IIT Jodhpur</a>
                </li>
                <li className="mb-4">
                  <a href="/team" className="hover:underline">Alumni Portal</a>
                </li>
              </ul>
            </div>
            <div>
              <h2 className="mb-6 text-sm font-extrabold text-gray-900 uppercase dark:text-black">Follow us</h2>
              <ul className="text-gray-500 dark:text-black font-medium">
                <li className="mb-4">
            ...
            <div>
              <h2 className="mb-6 text-sm font-extrabold text-gray-900 uppercase dark:text-black">Legal</h2>
              <ul className="text-gray-500 dark:text-black font-medium">
                <li className="mb-4">
